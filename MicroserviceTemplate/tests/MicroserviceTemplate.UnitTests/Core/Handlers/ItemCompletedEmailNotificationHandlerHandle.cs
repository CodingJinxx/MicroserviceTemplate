...
using MicroserviceTemplate.Core.ProjectAggregate.Events;
using MicroserviceTemplate.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace MicroserviceTemplate.UnitTests.Core.Handlers;
